...
def test():
    ...
    #rpc = Rpc(rpc='https://rpc.goerli.linea.build/', chainid=59140, proxies=p)

    rpc = Rpc(rpc='https://mainnet.infura.io/v3/a4c5b4ef4d704823980c3349f3b99d18', proxies=p)

    num = int(rpc.get_current_block()['result'][2:], 16)
    print(num)
    gas = int(rpc.get_gas_price()['result'][2:], 16)
    print('gas:',gas)
